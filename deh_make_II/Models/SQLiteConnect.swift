...
class SQLiteConnect {
    ...
    // 刪除資料
    func delete(_ tableName :String, cond :String, id : Int32) -> Bool {
        var statement :OpaquePointer? = nil
        var sql = "delete from \(tableName)"
        
        sql += " where \(cond) like \(id)"
    ...
    func delete_user(_ tableName :String, cond :String, user : String) -> Bool {
        var statement :OpaquePointer? = nil
        var sql = "delete from \(tableName)"
        
        sql += " where \(cond) like \(user)"
